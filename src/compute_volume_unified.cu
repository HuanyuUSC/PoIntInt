...
// Note: compute_intersection_volume_gradient_kernel is defined in compute_intersection_volume_gradient.cu
// and is accessible here via CUDA separable compilation (CUDA_SEPARABLE_COMPILATION ON).
// Forward declaration for the kernel - must match the extern "C" linkage of the definition
extern "C" {
  __global__ void compute_intersection_volume_gradient_kernel(
    const double2* __restrict__ grad_A1,
    const double2* __restrict__ grad_A2,
    const double2* __restrict__ A1,
    const double2* __restrict__ A2,
...
// ============================================================================
// Host Implementation: Intersection Volume Unified
// ============================================================================
  ...
  bool enable_profiling)
{
  ...
  if (enable_profiling) {
    ...
    std::cout << "\n=== CUDA Unified Intersection Volume Profiler ===" << std::endl;
